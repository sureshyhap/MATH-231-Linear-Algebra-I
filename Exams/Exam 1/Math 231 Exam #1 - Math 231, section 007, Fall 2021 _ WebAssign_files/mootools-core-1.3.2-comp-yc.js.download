...
o.isHTMLDocument=!!w.getElementById(c);}catch(v){}if(o.isHTMLDocument){if(z.style){z.style.display="none"};z.appendChild(w.createComment(""));n=(z.getElementsByTagName("*").length>1);
